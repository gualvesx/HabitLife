    ...
    <div className={s.page}>
      ...
      <nav className={[s.nav, scrolled ? s.navScrolled : ''].join(' ')}>
        ...
        <div className={s.navRight}>
          ...
          <button className={s.navCta}  onClick={onEnter}>Começar grátis</button>
        </div>
      </nav>
      ...
      <section className={s.hero} ref={heroRef}>
        ...
        <div className={[s.brainWrap, heroVis ? s.visible : ''].join(' ')}>
          ...
          <div className={s.brainLabel}>
            ...
            <span>Amethyst Cortex · 3D Interativo</span>
          </div>
        </div>
      </section>
      ...
      <section className={s.ctaSection} ref={ctaRef}>
        <div className={[s.ctaInner, ctaVis ? s.visible : ''].join(' ')}>
          ...
          <div className={s.ctaBadge}><div className={s.heroBadgeDot}/><span>Gratuito para sempre</span></div>
